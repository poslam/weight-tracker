...
mixin _$CategoryListState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<CategoryEntity> data) data,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<CategoryEntity> data)? data,
...
class _$DataImpl with DiagnosticableTreeMixin implements _Data {
  const _$DataImpl({required final List<CategoryEntity> data}) : _data = data;
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CategoryListState.data(data: $data)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'CategoryListState.data'))
...
abstract class _Data implements CategoryListState {
  const factory _Data({required final List<CategoryEntity> data}) = _$DataImpl;
...
class _$ErrorImpl with DiagnosticableTreeMixin implements _Error {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CategoryListState.error(msg: $msg)';
  }
